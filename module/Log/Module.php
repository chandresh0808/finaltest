                    ...
                    if (!file_exists($folderPath)) { 
                        ...
                        if (!mkdir($folderPath, 0777, true)) { 
                            throw new \Exception(5002);
                             ...
                             #exec('sudo chown www-data:www-data '.$folderPath);
                             exec('sudo chown www-data:www-data '.$folderPath);
                             touch($folderPath.'/application.log');
                             exec('sudo chmod 777 -R  '.$folderPath);
                             exec('sudo chown -R www-data:www-data '.$folderPath.'/application.log');
                        }
                    } 
