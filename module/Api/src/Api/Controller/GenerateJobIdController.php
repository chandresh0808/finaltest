...
class GenerateJobIdController extends AbstractCoreController
{
    /**
    ...
    public function create()
    {
        ...
        $jobIdArray = $this->getApiManagerService()->generateJobId($sessionGuid);   
        return new JsonModel($jobIdArray);
    }
