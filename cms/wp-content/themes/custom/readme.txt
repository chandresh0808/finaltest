...
Launch your new site with custom, built with Bootstrap 3.0.2 custom is lightweight and fully responsive. You can add your own background, set page layouts and more. custom supports eight post formats: Video, Image, Aside, Status, Audio, Quote, Link and Gallery. Recommends using Jetpack and is compatible with bbPress & BuddyPress. Built with Google Fonts, hence 'custom', for improved typeface readability and works perfectly across all devices!
...
For instance in the media.php you can change the custom front to any of your chosing, and in the theme-options you can change the star icon or delete it!
...
custom came in to being when I downloaded WARD by Chris Bavota http://wordpress.org/themes/ward , and being interested in Bootstrap and mobile first design. I decided to launch my own varient of the theme. 
...
text-domain changed from cdc_custom to custom
cyber_dc_boot changed to custom
Fixed bug with text on customer header.

v1.9.5
Added 'Template: custom' to child-theme zip so it functions properly.
...
Commented out delete_option( 'cdc_custom_theme_options' ); in theme-options.php so now custom headers in fully functional default id 'off'. 
...
Fixed Fatal Error custom now fully supports Custom Header
...
Added custom.po and custom.mo in /languages via POEdit: Translation Ready.
