...
function custom_setup() {
	...
	register_nav_menu( 'footer_left', __( 'Footer 1st Block', 'custom' ) );
	
	register_nav_menu( 'footer_right', __( 'Footer 2nd Block', 'custom' ) );
	
	register_nav_menu( 'footer_last', __( 'Footer 3rd Block', 'custom' ) );
...
function wpgyan_widgets_init() {
	...
	register_sidebar( array(
			...
			'before_widget' => '<div class="container home_text mar-t20"><div class="row"><div class="col-md-push-7 col-md-5 col-lg-push-6 col-lg-6">',
	...
	register_sidebar( array(
			'name' => 'Contact Get support',
			'id' => 'contact_support',
			'before_widget' => '<div class="contact_support">',
			'after_widget' => '</div>',
			//'before_title' => '<h2 class="rounded">',
			//'after_title' => '</h2>',
	) );
	...
	register_sidebar( array(
			'name' => 'Contact Office Address',
			'id' => 'contact_address',
			'before_widget' => '<div class="contact_address">',
			'after_widget' => '</div>',
			//'before_title' => '<h2 class="rounded">',
			//'after_title' => '</h2>',
	) );
