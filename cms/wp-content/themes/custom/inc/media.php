...
function custom_styles() {
	...
	?>
<style>
.container, .boxed #page, #main > .row, .home #primary article > .row, .archive #primary article > .row, .search #primary article > .row { max-width: <?php echo $custom_theme_options['width']; ?>px; }
</style>
	<?php
}
...
if ( ! function_exists( 'custom_add_js' ) ) :
/**
...
function custom_add_js() {
	...
	wp_enqueue_script( 'bootstrap', CYBER_DC_custom_URL .'/js/bootstrap.min.js', array( 'jquery' ), '2.2.2', true );
	...
	wp_enqueue_style( 'main', CYBER_DC_custom_URL .'/css/main.css', false, '3.1.0', 'all' );
