...
function testimonial_post_type() {
		$labels = array(
		'name' => _x('SliderContents', 'post type general name'),
		'singular_name' => _x('SliderContent', 'post type singular name'),
		'add_new' => _x('Add New', 'SliderContent'),
		'add_new_item' => __('Add New SliderContent'),
		'edit_item' => __('Edit SliderContent'),
		'new_item' => __('New SliderContent'),
		'all_items' => __('All SliderContents'),
		'view_item' => __('View SliderContent'),
		'search_items' => __('Search Testimonials'),
		'not_found' =>  __('No testimonials found'),
		'not_found_in_trash' => __('No testimonials found in Trash'), 
		'parent_item_colon' => '',
		'menu_name' => 'SliderContents'
